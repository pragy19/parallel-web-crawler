...
public final class CrawlerConfiguration {
  ...
  public static final class Builder {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("startPages")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("ignoredUrls")
     ...
     * @param patterns one or more regular expressions that define a valid {@link Pattern}.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("ignoredWords")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("implementationOverride")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("popularWordCount")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("profileOutputPath")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("resultPath")
